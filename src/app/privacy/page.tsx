...
const sections = [
  ...
  },
  {
    ...
    body: "Some forms continue the conversation through WhatsApp only after the website has successfully recorded the enquiry in PAMA Estates' internal CRM. WhatsApp is a separate service and its own terms and privacy practices apply when you choose to use it.",
  },
  {
  ...
  },
  {
    ...
    body: "Business enquiry records may be retained where reasonably required for client service, transaction history, legal or regulatory obligations and legitimate business administration. If you want to ask about information you submitted, request a correction or raise a privacy concern, contact PAMA Estates using the details below.",
  },
]
      ...
      <section className="border-t border-white/[0.08] bg-[#0F131B]">
        <div className="mx-auto max-w-5xl px-6 py-20 md:px-10 lg:py-28">
          ...
          <p className="mt-7 max-w-3xl text-base leading-8 text-[#B5BAC3] md:text-lg">
            PAMA Estates handles website enquiries as private business communications. This notice explains the information the current website collects through its enquiry flows and how that information is used.
          </p>
