        ...
        <div className="mx-auto max-w-4xl px-6 py-24 md:px-10 lg:py-28 fade-up-delay-2">
          <div className="border border-white/10 bg-white/5 p-8 shadow-[0_10px_40px_rgba(0,0,0,0.25)] backdrop-blur-xl transition duration-300 hover:border-[#D4AF37]/30 md:p-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div><label className="text-sm text-gray-300">Your Role</label><select name="role" onChange={handleChange} value={form.role} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40"><option value="">Select</option><option>Property Owner</option><option>Owner Representative</option></select></div>
              <div><label className="text-sm text-gray-300">Purpose</label><select name="purpose" onChange={handleChange} value={form.purpose} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40"><option value="">Select</option><option>Sell</option><option>Rent Out</option></select></div>
              <div><label className="text-sm text-gray-300">Property Type</label><select name="propertyType" onChange={handleChange} value={form.propertyType} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40"><option value="">Select</option><option>Villa</option><option>Apartment</option><option>Penthouse</option><option>Entire Floor</option><option>Plot</option><option>Building</option></select></div>
              <div><label className="text-sm text-gray-300">Property Location</label><input name="location" value={form.location} onChange={handleChange} placeholder="Palm Jumeirah, Emirates Hills, Dubai Marina..." className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40" /></div>
              <div><label className="text-sm text-gray-300">Timeline</label><select name="timeline" onChange={handleChange} value={form.timeline} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40"><option value="">Select</option><option>Just Exploring</option><option>Ready Immediately</option><option>Near Future</option></select></div>
              <div><label className="text-sm text-gray-300">Expected Price</label><input name="price" value={form.price} onChange={handleChange} placeholder="AED ..." className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40" /></div>
              <div><label className="text-sm text-gray-300">Full Name</label><input name="name" value={form.name} onChange={handleChange} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40" /></div>
              <div><label className="text-sm text-gray-300">WhatsApp</label><input name="whatsapp" value={form.whatsapp} onChange={handleChange} placeholder="+971..." className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40" /></div>
              <div><label className="text-sm text-gray-300">Email</label><input name="email" value={form.email} onChange={handleChange} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40" /></div>
              <div><label className="text-sm text-gray-300">Preferred Contact</label><select name="contactMethod" onChange={handleChange} value={form.contactMethod} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40"><option value="">Select</option><option>WhatsApp</option><option>Call</option><option>Email</option></select></div>
              <div className="md:col-span-2"><label className="text-sm text-gray-300">Marketing Preference</label><select name="marketing" onChange={handleChange} value={form.marketing} className="mt-2 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40"><option value="">Select</option><option>Public Listing</option><option>Off-Market Only</option><option>Need Advice</option></select></div>
              <div className="md:col-span-2"><label className="text-sm text-gray-300">Additional Information</label><textarea name="notes" value={form.notes} onChange={handleChange} className="mt-2 h-32 w-full border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition duration-300 focus:border-[#D4AF37] focus:bg-black/40" /></div>
              ...
              <div className="md:col-span-2">
                <button type="button" onClick={handleSubmit} disabled={isSubmitting} className="w-full rounded-sm bg-[#D4AF37] py-4 font-medium text-black transition duration-300 hover:-translate-y-0.5 hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60">{isSubmitting ? "Securely recording your property enquiry..." : "Submit & Connect via WhatsApp"}</button>
