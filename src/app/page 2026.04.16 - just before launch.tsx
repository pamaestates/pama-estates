    ...
    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
      <div>
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          ...
          <a
            href="https://wa.me/971559003888?text=Hello%20PAMA%20Estates,%0A%0AI%20reached%20you%20via%20pamaestates.com%20(Owner%20Inquiry)%20%0A%0AI%20am%20a%20property%20owner%20interested%20in%20selling%20or%20renting%20my%20property.%0A%0ACould%20you%20please%20assist%3F"
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center rounded-sm border border-white/20 bg-white/5 px-8 py-4 text-base font-medium hover:bg-white hover:text-black transition"
          >
      ...
      <div className="border border-white/10 bg-white/5 p-10 text-center transition duration-300 hover:border-[#D4AF37]/40 hover:bg-white/[0.07]">
        <Crown className="mx-auto h-6 w-6 text-[#D4AF37]" />
