      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#0B0E15]/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 md:px-10">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-gray-200">
            ...
            <button
              type="button"
              onClick={() => scrollToSection("why-pama")}
              className="hover:text-[#D4AF37] transition"
            >
              About
            </button>
            <button
              type="button"
              onClick={() => scrollToSection("featured-areas")}
              className="hover:text-[#D4AF37] transition"
            >
              Areas
            </button>
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
            <div className="group border border-white/10 bg-white/5 p-8 transition hover:border-[#D4AF37]/40 hover:bg-white/[0.07]">
              ...
              <button
                type="button"
                onClick={() => scrollToSection("private-access")}
                className="mt-8 text-sm font-medium text-white transition group-hover:text-[#D4AF37]"
              >
                Explore Area →
              </button>
            </div>
